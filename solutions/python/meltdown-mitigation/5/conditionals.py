...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    """
    criticality = (temperature < 800) and (neutrons_emitted > 500) and (temperature * neutrons_emitted < 500000) 
    return criticality      
...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    """
    genereted_power = voltage * current 
    effeciency_pourcentage = (genereted_power/theoretical_max_power)*100 
    if effeciency_pourcentage >=80: 
        say = "green"
    elif 80 > effeciency_pourcentage >= 60:
        say = "orange"
    elif 60 > effeciency_pourcentage >= 30: 
        say = "red"
    else: 
        say = "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    threshold_110 = (threshold * 0.1) + threshold

    if criticality < threshold_90: 
        say = "LOW"
    elif threshold_90 <= criticality <= threshold_110: 
        say = "NORMAL"
    else: 
        say = "DANGER"
